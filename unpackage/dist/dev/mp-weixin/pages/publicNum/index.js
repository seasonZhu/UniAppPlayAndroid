...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/publicNum/index.vue */ 73));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_0e3f4937___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=0e3f4937& */ 74);
...
var _default =
{
  ...
  methods: {
    getPublicNumTopic: function getPublicNumTopic() {var _this = this;
      this.$u.api.publicNumTopic().then(function (res) {
        _this.topics = res;
      });
    },
    // tabs通知swiper切换
